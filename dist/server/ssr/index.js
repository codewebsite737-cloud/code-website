...
var client_references_default = {
	...
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-BrPHNofA.js");
		return {
			get "ErrorBoundary"() {
	...
	"a324307afb83": async () => {
		const m = await import("./assets/DashboardClient-nRzyYzLU.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"a8c58a62f4a4": async () => {
		const m = await import("./assets/page-DKPitzII.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"a9bbde40cf2d": async () => {
		const m = await import("./assets/error-CH8W_epa.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-ZKziRYeH.js").then((n) => n.n);
		return { get "default"() {
			return m["default"];
		} };
	}
